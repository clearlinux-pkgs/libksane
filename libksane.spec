...
Version  : 22.12.0
Release  : 45
URL      : https://download.kde.org/stable/release-service/22.12.0/src/libksane-22.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/libksane-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/libksane-22.12.0.tar.xz.sig
...
%prep
%setup -q -n libksane-22.12.0
cd %{_builddir}/libksane-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670511580
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5Sane.so.22.12.0
