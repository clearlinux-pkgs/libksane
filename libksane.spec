...
Source0  : https://download.kde.org/stable/release-service/21.08.2/src/libksane-21.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.2/src/libksane-21.08.2.tar.xz.sig
...
%prep
%setup -q -n libksane-21.08.2
cd %{_builddir}/libksane-21.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634326203
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libksane-21.08.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/libksane/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/libksane-21.08.2/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/libksane/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/libksane-21.08.2/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/libksane/19d98e1b6f8ef12849ea4012a052d3907f336c91
cp %{_builddir}/libksane-21.08.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/libksane/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/libksane-21.08.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/libksane/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5Sane.so.21.08.2
