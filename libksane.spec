...
Version  : 23.08.5
Release  : 60
URL      : https://download.kde.org/stable/release-service/23.08.5/src/libksane-23.08.5.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/libksane-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/libksane-23.08.5.tar.xz.sig
...
%prep
%setup -q -n libksane-23.08.5
cd %{_builddir}/libksane-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708373711
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Sane.so.23.08.5
/usr/lib64/libKF5Sane.so.23.08.5
