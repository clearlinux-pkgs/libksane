...
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/libksane-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/libksane-24.08.2.tar.xz.sig
...
%setup -q -n libksane-24.08.2
cd %{_builddir}/libksane-24.08.2
pushd ..
cp -a libksane-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728575710
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKSaneWidgets6.so.24.08.2
/usr/lib64/libKSaneWidgets6.so.24.08.2
