...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/libksane-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/libksane-24.02.0.tar.xz.sig
...
%prep
%setup -q -n libksane-24.02.0
cd %{_builddir}/libksane-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710375546
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKSaneWidgets6.so.24.02.0
/usr/lib64/libKSaneWidgets6.so.24.02.0
