...
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/libksane-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/libksane-23.04.0.tar.xz.sig
...
%prep
%setup -q -n libksane-23.04.0
cd %{_builddir}/libksane-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682012374
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5Sane.so.23.04.0
