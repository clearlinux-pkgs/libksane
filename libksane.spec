...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/libksane-22.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.0/src/libksane-22.08.0.tar.xz.sig
...
%prep
%setup -q -n libksane-22.08.0
cd %{_builddir}/libksane-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661783751
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5Sane.so.22.08.0
